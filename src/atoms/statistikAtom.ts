...
export const statistikKediriAtom = atomWithStorage<StatistikTes>('statistik-kediri', {
      "periode_tes": null,
      "overall": {
...
export const statistikKertosonoAtom = atomWithStorage<StatistikTes>('statistik-kertosono', {
      "periode_tes": null,
      "overall": {
        "total_active_peserta": null,
        "min_akademik_per_peserta": null,
