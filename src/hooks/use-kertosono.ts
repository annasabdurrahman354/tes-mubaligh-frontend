...
export function useKertosono() {
    ...
    const getPesertaKertosonoByRFID = async (rfid: string): Promise<PesertaKertosono | null | any> => {
      try {
    ...
    return { getPesertaKertosono, getPesertaKertosonoByRFID, storeAkademikKertosono, storeAkhlakKertosono };
  }
