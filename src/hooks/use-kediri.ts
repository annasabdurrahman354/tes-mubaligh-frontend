...
export function useKediri() {
    ...
    const getPesertaKediriByRFID = async (rfid: string): Promise<PesertaKediri | null | any> => {
      try {
    ...
    return { getPesertaKediri, getPesertaKediriByRFID, storeAkademikKediri, storeAkhlakKediri };
  }
